...
const newsItems = [
  {
    ...
    title: 'Eagles Volleyball Team Captures Regional Championship',
    excerpt: 'Our varsity volleyball team clinched the regional title in a thrilling five-set victory.',
  },
  {
    image: newsScience,
    category: 'STEM',
    date: 'January 22, 2026',
    title: 'Students Showcase Innovations at Annual Science Fair',
    excerpt: 'From renewable energy solutions to AI-powered assistants, our young innovators impressed judges.',
  },
  {
    image: newsArts,
    category: 'Performing Arts',
    date: 'January 15, 2026',
    title: 'Winter Production of "Les Misérables" Receives Standing Ovation',
    excerpt: 'Three sold-out performances showcased the exceptional talent of our drama and music departments.',
  },
];
